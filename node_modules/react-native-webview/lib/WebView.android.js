...
import { ActivityIndicator, Image, requireNativeComponent, UIManager as NotTypedUIManager, View, NativeModules, findNodeHandle, } from 'react-native';
...
var WebView = /** @class */ (function (_super) {
    ...
    WebView.prototype.render = function () {
        ...
        var webViewStyles = [styles.container, style];
        if (this.state.viewState === 'LOADING'
